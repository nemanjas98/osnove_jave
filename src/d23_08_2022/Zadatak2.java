...
//
		...
		Racun posiljalac = new Racun("100-350-999", "Nikola Nikolic", 6000);
		Racun primalac = new Racun ("215-100-222", "Nikolina Nikolic", 100);
		Transakcija t = new Transakcija ("e12", posiljalac, primalac);
